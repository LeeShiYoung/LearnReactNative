//
//  CallAddressBookViewController.m
//  Hybrid
//
...
@interface CallAddressBookViewController ()<ABPeoplePickerNavigationControllerDelegate>

@end

@implementation CallAddressBookViewController
